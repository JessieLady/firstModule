//Hi, Jessie from the future!
//I think we're gonna need to use the same .js for both .html files
//because we need to charge the tasks from each user respectively 
